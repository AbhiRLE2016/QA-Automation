Feature: SauceDemo end-to-end checkout for the red t-shirt
  As a SauceDemo customer
  I want to log in, add the red t-shirt to my cart, and complete checkout
  So that I can place an order and see the order confirmation page

  Scenario: Complete checkout for the red t-shirt
    Given the user opens "https://www.saucedemo.com/"
    When the user logs in with username "standard_user" and password "secret_sauce"
    And the user adds the red t-shirt to the cart

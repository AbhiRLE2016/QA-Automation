...
- **Story id:** `localhost_5173/the_user_opens__94f757a7`
- **Last updated:** 2026-05-21 12:06:43
...
- `features/story_1_manager_employee_revenue_pli_flow.feature` — Manager end-to-end flow — login, add employee, set performance KPIs, add revenue, verify PLI

## Tests

- `tests/test_story_1_manager_employee_revenue_pli_flow.py`
...
Then  the URL changes to "http://localhost:5173/show-pli/499"
 ...
 And  the table contains a row with the following values:
        Emp ID                  : 7777
